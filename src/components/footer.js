...
export default function Footer() {
  ...
  return (
    <div
      style={{ marginLeft: "var(--space-l)", marginRight: "var(--space-l)" }}
    >
      <Section title="Connect">
        <div className={styles.connect}>
          <div className={styles.container}>
            <div className={styles.container}>
              <h2 style={{ marginTop: "var(--space-m)", marginBottom: 0 }}>
                {site.siteMetadata.author.name}
              </h2>
              <h3 style={{ margin: 0 }}>{site.siteMetadata.author.role}</h3>
              <small>Ancona, Italy</small>
              <a href="mailto:mirco.bellag@gmail.com">
