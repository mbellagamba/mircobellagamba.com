...
function applyColorScheme(value) {
	...
	getToggleButton().innerHTML =
		value === DARK_COLOR_SCHEME ? DARK_SVG_ICON : LIGHT_SVG_ICON;
...
function initializeColorScheme() {
	...
	const mqColorScheme = (mq) =>
		mq.matches ? DARK_COLOR_SCHEME : LIGHT_COLOR_SCHEME;
